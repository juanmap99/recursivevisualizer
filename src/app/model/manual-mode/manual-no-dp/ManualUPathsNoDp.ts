...
export class ManualUPathsNoDp extends ManualAlg{
    setInitState(): ManualState {
        ...
        return {
            lineExec : 10,
            posIdCol : -1,
            varState: [filas-1,columnas-1,undefined,undefined,undefined,1,0,0],
            varDesc: ["fila","col","pathsMovingL","pathsMovingD","totalPaths","counter","curDepth","returnCounter"]
        }
    }
