...
export class ManualTSumNoDp extends ManualAlg{
    setInitState(): ManualState {
        ...
        return {
            lineExec : 10,
            posIdCol : 2,
            varState: [arrayElem,targetSum,arrayElem.length-1,0,undefined,undefined,undefined,1,0,0],
            varDesc: ["nums","target","index","curr_sum","solsSumando","solsRestando","totalSol","counter","curDepth","returnCounter"]
        }
    }
