...
export class ManualCombNoDp extends ManualAlg{
    setInitState(): ManualState {
        ...
        return {
            lineExec : 1,
            posIdCol : 1,
            varState: [arrayElem,targetSum,-1,0,1,0,0],
            varDesc: ["nums","target","index","totalSol","counter","curDepth","returnCounter"]
        }
    }
    ...
    ejecutarLineaTres(state : ManualState){
        ...
        this.tableServ.addOutputByCounter(state.varState[4],1);
        state.lineExec = -1;
        return state;
    }
