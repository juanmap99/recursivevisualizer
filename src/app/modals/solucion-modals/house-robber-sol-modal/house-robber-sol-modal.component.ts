...
@Component({
  selector: 'app-house-robber-sol-modal',
  templateUrl: './house-robber-sol-modal.component.html',
  styleUrls: ['./house-robber-sol-modal.component.scss']
})
export class HouseRobberSolModalComponent{
