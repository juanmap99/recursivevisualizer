...
@Component({
  selector: 'app-unique-paths-sol-modal',
  templateUrl: './unique-paths-sol-modal.component.html',
  styleUrls: ['./unique-paths-sol-modal.component.scss']
})
export class UniquePathsSolModalComponent{
