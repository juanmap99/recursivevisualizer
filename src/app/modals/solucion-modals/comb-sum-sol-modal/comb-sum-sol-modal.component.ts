...
@Component({
  selector: 'app-comb-sum-sol-modal',
  templateUrl: './comb-sum-sol-modal.component.html',
  styleUrls: ['./comb-sum-sol-modal.component.scss']
})
export class CombSumSolModalComponent{
