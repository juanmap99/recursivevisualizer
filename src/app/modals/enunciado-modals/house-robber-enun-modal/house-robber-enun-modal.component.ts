...
@Component({
  selector: 'app-house-robber-enun-modal',
  templateUrl: './house-robber-enun-modal.component.html',
  styleUrls: ['./house-robber-enun-modal.component.scss']
})
export class HouseRobberEnunModalComponent{
