...
@Component({
  selector: 'app-target-senun-modal',
  templateUrl: './target-senun-modal.component.html',
  styleUrls: ['./target-senun-modal.component.scss']
})
export class TargetSEnunModalComponent{
