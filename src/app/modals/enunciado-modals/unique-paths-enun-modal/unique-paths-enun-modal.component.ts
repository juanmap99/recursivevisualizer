...
@Component({
  selector: 'app-unique-paths-enun-modal',
  templateUrl: './unique-paths-enun-modal.component.html',
  styleUrls: ['./unique-paths-enun-modal.component.scss']
})
export class UniquePathsEnunModalComponent{
