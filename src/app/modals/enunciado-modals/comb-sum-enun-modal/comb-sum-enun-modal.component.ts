...
@Component({
  selector: 'app-comb-sum-enun-modal',
  templateUrl: './comb-sum-enun-modal.component.html',
  styleUrls: ['./comb-sum-enun-modal.component.scss']
})
export class CombSumEnunModalComponent{
